...
class ONCEDataset(DatasetTemplate):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        if 'annos' not in self.once_infos[0].keys():
            return None, {}
...
def create_once_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    splits = ['train', 'trainval', 'val', 'test', 'raw_small', 'raw_medium', 'raw_large']
    # ignore = ['test']
    ...
    train_split_list = ['train', 'trainval']
